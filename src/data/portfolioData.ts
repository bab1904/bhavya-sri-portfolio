  ...
  certifications: [
    {
      ...
      name: "Semiconductor Roadshow: RTL-to-GDS & RISC-V Workflow",
      issuer: "VSD & SSA (IIT Bombay Chapter)",
    ...
    },
    {
      ...
      name: "Advanced Semiconductor Workforce Development (ISWDP)",
    ...
    },
    {
      ...
      name: "ISWDP Level 2: Device Simulation & TCAD Scripting",
      issuer: "Samsung, Synopsys & IISc Bangalore",
      category: "Physical Design & VLSI",
    ...
    },
    {
      ...
      name: "Samsung Fellowship — Grade II (ISWDP)",
      issuer: "Samsung Semiconductor India Research & IISc",
      category: "Physical Design & VLSI",
      skills: ["Semiconductor Architecture", "Hardware Innovation", "Silicon Engineering"],
      featured: true,
    },
    {
      id: "chipstart",
    ...
    {
      id: "nielit-echiphub",
      name: "eChipHub Chip Design Internship (MeitY)",
    ...
    {
      id: "fpga-tcl",
      name: "FPGA Design Flow & TCL Scripting in Vivado",
    ...
    {
      id: "nielit-rtl-gds",
      name: "VLSI Design Flow (RTL to GDS-II) — 90 Hours",
      issuer: "NIELIT (MeitY)",
      category: "Physical Design & VLSI",
    ...
    },
    {
      ...
      name: "ISWDP Level 1: Semiconductor Device Tech & TCAD",
      issuer: "Samsung, Synopsys & IISc Bangalore",
      category: "Physical Design & VLSI",
      skills: ["Device Technology", "TCAD Workflow", "2D Device Creation"],
      featured: false,
    },
    {
      id: "shristi-verilog",
      name: "4-Day Verilog HDL Master Workshop",
      issuer: "Shristi Silicon — VLSI Training Institute",
      category: "Physical Design & VLSI",
      skills: ["Synthesizable Verilog", "FSM Design", "RTL Verification"],
      featured: false,
    },
    {
      id: "google-ambassador",
      ...
      skills: ["Google AI Tools", "Technical Leadership", "Gemini AI"],
      featured: false,
    },
    {
      id: "robotics-ai-savishkar",
      name: "4-Week National Robotics & AI Prototyping Workshop",
    ...
    {
      id: "iit-bombay-illuminate",
      name: "Illuminate Entrepreneurship Bootcamp Organizer",
      issuer: "E-Cell IIT Bombay",
      category: "Core Engineering",
      skills: ["Leadership", "Innovation Strategy", "Hackathon Organization"],
      featured: false,
    },
    {
      id: "maven-silicon-formal",
      name: "Formal Verification: New Paradigm of IC Verification",
      issuer: "Maven Silicon",
      category: "Physical Design & VLSI",
      skills: ["Formal Verification", "IC Verification", "Equivalence Checking"],
      featured: false,
    },
    {
      id: "chipxpert-rtl-gds",
      name: "VLSI Design Flow RTL to GDS with Industry Tools",
    ...
    {
      id: "nxtwave-genai",
      name: "Generative AI Mastery & India's Biggest GenAI Buildathon",
    ...
    {
      id: "vit-semis",
      name: "National Semiconductor Technology Symposium (NSTS)",
    ...
    {
      id: "nielit-vlsi-calicut",
      name: "VLSI for Beginners (Chips to Startup Programme)",
      issuer: "NIELIT Calicut (MeitY)",
      category: "Physical Design & VLSI",
      skills: ["Digital CMOS", "VLSI Fundamentals", "C2S Programme"],
      featured: false,
    },
    {
    ...
    },
    {
      ...
      category: "Software & Linux",
      skills: ["Python", "Data Science", "EDA Log Parsing"],
      featured: false,
    },
    {
      id: "simplilearn-vlsi",
      name: "VLSI Physical Flow & Digital Circuits",
    ...
    },
    {
      ...
      name: "Verilog HDL — Hands On & ASIC Netlists",
    ...
    {
      id: "ibm-linuxone",
      name: "Enterprise Linux Systems (IBM LinuxONE)",
      issuer: "IBM LinuxONE",
      category: "Software & Linux",
    ...
    },
    {
      ...
      name: "Digital Electronic Circuits (Elite)",
      issuer: "NPTEL (IIT Kharagpur / Ministry of Education)",
      category: "Core Engineering",
      skills: ["Digital Logic", "Combinational Circuits", "Sequential Analysis"],
      featured: true,
    },
  ] as Certification[],
